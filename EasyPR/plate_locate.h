...
namespace easypr {
	...
	public:
		...
		inline void setMaxPlates(int param) { m_maxPlate = param; }
		inline int getMaxPlates() const { return m_maxPlate; }

		inline void setType(int param) { m_type = param; }
